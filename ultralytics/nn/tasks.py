...
from ultralytics.nn.modules.block import C2f_ScConv
...
import ultralytics.nn.modules.dysample as dysample
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        globals()['nn.Dysample'] = dysample.DySample
        # print(m)
        if m == "nn.Dysample":
            m = "DySample"
        elif m == 'nn.ECAAttention':
            m = 'ECAAttention'
        elif m == 'nn.CoordAtt':
            m = 'CoordAtt'
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_Faster, C2f_Faster_EMA}:
